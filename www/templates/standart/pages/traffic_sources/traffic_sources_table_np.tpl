	...
	<div class="header-container">
		<table class="stat_header">
			<tr>
				...
				<td class="llh_td "  style="display:none"id="hrow6"></td>	
				<td class="plh_td " style="display:none" id="hrow7"></td>	
				<td class="lastlead_td " style="display:none" id="hrow8"></td>	
				...
				<td class="leads_td " style="display:none" id="hrow10"></td>							
				<td class="cr_td " style="display:none" id="hrow11"></td>							
				<td class="epc_td " style="display:none" id="hrow12"></td>			
				...
				<td class="revenue_td " style="display:none" id="hrow14" ></td>							
				...
				<td class="proft_td" style="display:none" id="hrow16"></td>							
				<td class="roi_td" style="display:none" id="hrow17"></td>
			</tr>
		</table>
	</div>
		...
		<table class="table_stat camps_table noncheckbox_table" cellspacing="0" width="100%">
			<tbody>
				<?php $sum_clicks=0;$sum_leads=0;$sum_rev=0;$sum_spend=0;$row_counter=0;
					...
					<tr id="ts_<?php echo $row['id'] ?>" class="table_stat_tr tr_profit_2 visible_row <?php echo ($row_counter % 2 == 1?'gray_row':'')?>""

						ondblclick="edit();" onclick="hide_button(this,'<?php echo $row['status'] ?>', '<?php echo $row['camps'] ?>') ;"
	...
	<div class="footer-container">
			<table class="stat_footer">
				<tr> 
					...
					<td id="frow10"  class="leads_td " style="display:none"></td>
					<td id="frow11"  class="cr_td " style="display:none"></td>
					<td id="frow12"  class="epc_td " style="display:none"></td>
					<td id="frow13"  class="cpc_td table_td_stat">
						$<?php echo ($sum_clicks>0?number_format(($sum_spend / $sum_clicks),4):0) ?>
					</td>
					<td id="frow14"  class="revenue_td " style="display:none"></td>
					<td id="frow15"  class="cost_td table_td_stat">
						$<?php echo number_format($sum_spend,2) ?>
					</td>
					<td id="frow16" class="profit_td" style="display:none"></td>
					<td id="frow17" class="roi_td" style="display:none"></td>
				</tr>
			</table>
	</div>
