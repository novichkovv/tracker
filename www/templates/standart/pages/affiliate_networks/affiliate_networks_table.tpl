	...
	<div class="header-container">
		<table class="stat_header">
			<tr>
				...
				<td class="llh_td table_td_info" id="hrow5">
					<b>LLH</b>
				</td>	
				<td class="plh_td table_td_info" id="hrow6">
					<b>PLH</b>
				</td>	
				<td class="lastlead_td table_td_info" id="hrow7">
					<b>Last lead</b>
				</td>	
				...
				<td class="revenue_td table_td_stat" id="hrow13" >
		...
		<table class="table_stat camps_table noncheckbox_table" cellspacing="0" width="100%">
			...
			<tbody>
				<?php $sum_clicks=0;$sum_leads=0;$sum_rev=0;$sum_spend=0;$row_counter=0;
					foreach($arr_tpl["rows"] as $row) { 
					$sum_clicks+=$row["clicks"];$sum_leads+=$row["cnt_cnv"];$sum_rev+=$row["summ_cnv"];$sum_spend+=$row["spend"]?>
					...
					data-options="<?php echo $row['options'] ?>"> 
	...
	<div class="footer-container">
			<table class="stat_footer">
				<tr> 
					...
					<td id="frow9"  class="leads_td table_td_stat">
						<?php echo number_format($sum_leads) ?>
					</td>
					<td id="frow10"  class="cr_td table_td_stat">
						<?php echo ($sum_clicks>0?number_format((($sum_leads  / $sum_clicks)*100),2):0)?>%
					</td>
					<td id="frow11"  class="epc_td table_td_stat">
					...
					<td id="frow16" class="roi_td <?php if(($sum_rev-$sum_spend)>0){
															echo 'color_stat_1';
															}else if(($sum_rev-$sum_spend)==0){
															echo 'color_stat_2';
															}else{
