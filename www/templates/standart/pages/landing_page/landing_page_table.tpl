	...
	<div class="header-container">
		<table class="stat_header">
			<tr>
				...
				<td class="revenue_td table_td_stat" id="hrow15" >
		...
		<table class="table_stat camps_table" cellspacing="0" width="100%">
			...
			<tbody>
				<?php $sum_clicks=0;$sum_leads=0;$sum_rev=0;$sum_spend=0;$sum_offer_cl=0;$row_counter=0;
					...
					<tr id="land_<?php echo $row['id'] ?>" class="table_stat_tr 
					...
					onclick="hide_button(this,'<?php echo $row['status'] ?>');"
	...
	<div class="footer-container">
			<table class="stat_footer">
				<tr> 
					...
					<td id="frow11"  class="leads_td table_td_stat">
						<?php echo number_format($sum_leads) ?>
					</td>
					<td id="frow12"  class="cr_td table_td_stat">
						<?php echo ($sum_clicks>0?number_format((($sum_leads  / $sum_clicks)*100),2):0)?>%
					</td>
					<td id="frow13"  class="epc_td table_td_stat">
					...
					<td id="frow18" class="roi_td <?php if(($sum_rev-$sum_spend)>0){
															echo 'color_stat_1';
															}else if(($sum_rev-$sum_spend)==0){
															echo 'color_stat_2';
															}else{
